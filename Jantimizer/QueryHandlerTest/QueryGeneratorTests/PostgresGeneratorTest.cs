...
{
    [TestMethod]
    [DataRow("SELECT * FROM ((A JOIN B ON A.ID = B.ID) JOIN C ON B.ID = C.ID);", "SELECT * FROM (A JOIN B ON A.ID = B.ID) JOIN C ON B.ID = C.ID")]
    [DataRow("SELECT * FROM (((A JOIN B ON A.ID = B.ID) JOIN C ON B.ID = C.ID) JOIN D ON C.ID = D.ID);", "SELECT * FROM ((A JOIN B ON A.ID = B.ID) JOIN C ON B.ID = C.ID) JOIN D ON C.ID = D.ID")]
    ...
    [TestMethod]
    [DataRow("SELECT * FROM ((A JOIN B ON A.ID = B.ID) JOIN C ON B.ID = C.ID);", "SELECT * FROM (A JOIN B ON A.ID = B.ID) JOIN C ON B.ID = C.ID", new []{ 0, 10 })]
    [DataRow("SELECT * FROM ((B JOIN C ON B.ID = C.ID) JOIN A ON A.ID = B.ID);", "SELECT * FROM (A JOIN B ON A.ID = B.ID) JOIN C ON B.ID = C.ID", new []{ 10, 0 })]
