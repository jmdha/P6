...
namespace HistogramsTests.Unit_Tests.Models.Histograms
{
    ...
    public class HistogramMinDepthTests
    {
        ...
        public void Constructor_GeneratesBuckets()
        {
            // ARRANGE
            // ACT
            IDepthHistogram histogram = new HistogramMinDepth("A", "b", 1);
        ...
        public void Constructor_SetsProperties(string tableName, string attributeName, int depth)
        {
            // ARRANGE
            // ACT
            IDepthHistogram histogram = new HistogramMinDepth(tableName, attributeName, depth);
        ...
        {
            // ARRANGE
            IDepthHistogram histogram = new HistogramMinDepth("A", columnName, depth);
        ...
        {
            // ARRANGE
            IDepthHistogram histogram = new HistogramMinDepth("A", "b", bucketSize);
