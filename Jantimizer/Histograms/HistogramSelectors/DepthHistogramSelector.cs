...
namespace Histograms.HistogramSelectors
{
    public class DepthHistogramSelector : IDepthHistogramSelector<IDepthHistogram>
    {
        ...
        public IDepthHistogram GetHistogramDepthOfTypeOrAlt(IDepthHistogram targetType, Type type, string tableName, string attributeName, DepthCalculator getDepth)
        {
            ...
            switch (Type.GetTypeCode(type))
            {
                ...
                case TypeCode.Double:
                    histogram = new HistogramEquiDepthVariance(tableName, attributeName, getDepth);
                    break;
                case TypeCode.String:
                case TypeCode.Decimal:
                case TypeCode.Boolean:
                case TypeCode.DateTime:
                    histogram = new HistogramEquiDepth(tableName, attributeName, getDepth);
                    break;
                default:
