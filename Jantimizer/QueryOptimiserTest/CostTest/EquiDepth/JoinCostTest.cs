...
public class JoinCostTest
{
    ...
    {
        IHistogramManager histogramManager = new EquiDepthHistogramManager(null!, depth);
    ...
    {
        IHistogramManager histogramManager = new EquiDepthHistogramManager(new DataGathererStub(), depth);
    ...
    {
        var histogramManager = new EquiDepthHistogramManager(new DataGathererStub(), depth);
    ...
    {
        var histogramManager = new EquiDepthHistogramManager(null!, depth);
        var aGram = Utilities.CreateConstHistogram(Utilities.GetTableName(0), "ID", depth, aAmount, aValue);
        var bGram = Utilities.CreateConstHistogram(Utilities.GetTableName(1), "ID", depth, bAmount, bValue);
        histogramManager.AddHistogram(aGram);
        histogramManager.AddHistogram(bGram);
